...
docker cp 000_dns_domini01.conf dhcpdnsserver:/etc/dnsmasq.d/dhcp.conf
...
docker-compose ps
docker exec dhcpclient01 /bin/sh -c "ping -c 2 dns1.jiznardo.lab16"
docker exec dhcpclient01 /bin/sh -c "ping -c 2 client01.jiznardo.lab16"
docker exec dhcpclient01 /bin/sh -c "ping -c 2 client02.jiznardo.lab16"
docker exec dhcpclient01 /bin/sh -c "dig @72.28.1.100 NS jiznardo.lab16"
docker exec dhcpclient01 /bin/sh -c "dig @72.28.1.100  client01.jiznardo.lab16"
