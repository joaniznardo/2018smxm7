# lab18
## servidor dns bind - una única xarxa - creació d'un servidor de domini autoritari (de referència) amb un servidor de recolzament, invocat des d'un resolver (el 72.28.1.99 que fa el paper de 8.8.8.8)
